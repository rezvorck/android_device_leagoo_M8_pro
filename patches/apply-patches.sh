...
git apply -v ../../device/leagoo/M8_pro/patches/0020-healthd_batteryVoltage.patch
cd ../..
cd bionic
...
cd ../../..
cd frameworks/av
git apply -v ../../device/leagoo/M8_pro/patches/0018-EM-frameworks_av.patch
...
cd ../..
cd frameworks/base
git apply -v ../../device/leagoo/M8_pro/patches/0019-EM-frameworks_base.patch
cd ../..
cd system/netd
