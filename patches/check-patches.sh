...
cd ../../../..
cd system/core
git apply -v --check ../../device/leagoo/M8_pro/patches/0001-Remove-CAP_SYS_NICE-from-surfaceflinger.patch
git apply -v --check ../../device/leagoo/M8_pro/patches/0004-libnetutils-add-MTK-bits-ifc_ccmni_md_cfg.patch
git apply -v --check ../../device/leagoo/M8_pro/patches/0012-PATCH-xen0n-some-MTK-services-e.g.-ril-daemon-mtk-re.patch
git apply -v --check ../../device/leagoo/M8_pro/patches/0020-healthd_batteryVoltage.patch
cd ../..
cd bionic
